...
//Made a Node Class that will contain the char, it's freq, left node and right node
class Node{
    public : 
    char c;
    int freq;
...
void makingHuffMannCode(string input){
    ...
    priority_queue<Node*,vector<Node*>,comparatorFunction> HuffmannTree;
    ...
    int lengthOfOriginalString = 8*(input.length());   //char take 8 bytes
